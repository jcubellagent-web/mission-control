# Control Tower UI/UX Revamp — `ui-revamp-2026-04-19`

Historical note: this revamp applied to the legacy static `index.html` surface. Current Control Tower work means the Josh 2.0 React kiosk in `v2-react/` at `http://127.0.0.1:5174/`.
