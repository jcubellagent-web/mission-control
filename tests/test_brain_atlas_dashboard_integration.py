...
class BrainAtlasDashboardIntegrationTests(unittest.TestCase):
    ...
    def test_ui_contract_is_memory_first_with_on_demand_exact_proof(self) -> None:
        ...
        self.assertIn("Recall efficiency", component)
        self.assertIn("Selection to use", component)
        self.assertIn("Feedback quality", component)
        self.assertIn("selected -> used", component)
        self.assertIn("helpful outcomes", component)
        self.assertIn("Privacy ·", component)
        self.assertIn("boundary clean", component)
        self.assertIn("Review ·", component)
        self.assertIn("Registry ·", component)
        self.assertIn("crossOwnerPrivateLeaks", component)
        self.assertIn("activeOwnerPrivate", component)
