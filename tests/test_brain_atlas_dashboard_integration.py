...
class BrainAtlasDashboardIntegrationTests(unittest.TestCase):
    ...
    def test_ui_contract_is_memory_first_with_on_demand_exact_proof(self) -> None:
        ...
        self.assertIn("animation: memory-agent-receipt-dot 1.05s ease-in-out infinite;", memory_receipt_css)
        self.assertIn("filter: drop-shadow", memory_receipt_css)
        ...
        self.assertIn(".memory-flow-node.is-memory-live .memory-flow-memory-receipt-dot", reduced_motion)
