...
class BrainAtlasDashboardIntegrationTests(unittest.TestCase):
    ...
    def test_ui_contract_is_fixed_layered_and_evidence_driven(self) -> None:
        ...
        self.assertIn('aria-labelledby="brain-atlas-memory-heading"', component)
        self.assertIn('aria-describedby="brain-atlas-memory-description"', component)
        self.assertIn('aria-labelledby="brain-atlas-evidence-heading"', component)
        ...
        self.assertIn("Proof of what ran: agent → work → timestamped receipt → verified model", component)
        self.assertIn("Exact seven-day links only", component)
    ...
    def test_atlas_and_finops_are_always_visible_in_matched_grid_cells(self) -> None:
        ...
        self.assertIn("flex: 1.1 1 0;", styles)
        self.assertIn(".brain-atlas-section.is-evidence", styles)
        self.assertIn("flex: 1 1 0;", styles)
