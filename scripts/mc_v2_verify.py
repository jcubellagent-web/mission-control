#!/usr/bin/env python3
"""Verify dashboard-safe Control Tower canonical rows are readable."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Verify Control Tower canonical readable state.")
