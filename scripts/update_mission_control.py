...
CRON_TARGETS = [
    ...
    {"name": "Sorare Daily Missions Watchdog", "pattern": "sorare_daily_mission_watchdog.sh", "schedule": "Every 30 minutes from 7:00 AM ET", "description": "JAIMES sets and rechecks Daily Mission picks early and throughout the day, including early weekend slates", "category": "Sorare MLB", "agent": "JAIMES", "jain": True, "source": "hermes", "hermesName": "Sorare Daily Missions Watchdog"},
    ...
    {"name": "Sorare Fast Lane", "pattern": "jaimes_sorare_fast_lane.py", "schedule": "Every 2 hours", "description": "JAIMES refreshes read-only Sorare context so Telegram and Codex answers can start from current evidence", "category": "Sorare MLB", "agent": "JAIMES", "jain": True, "source": "launchd", "logPath": "/Users/jc_agent/.openclaw/workspace/mission-control/logs/jaimes-sorare-fast-lane.out.log"},
