...
CRON_TARGETS = [
    ...
    {"name": "Trump Monitor", "pattern": "trump_monitor.py", "schedule": "Every 5 min", "description": "Monitors Trump statements via Google News RSS, pushes score ≥7.5", "category": "Intelligence Feed"},
